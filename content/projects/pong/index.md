...
{{ image(src="main-game.png" alt="Main game screenshot") }}

### Start Screen

{{ image(src="start-screen.png" alt="Start screen screenshot") }}

### Main Game Start

{{ image(src="main-game-start.png" alt="Main game, round start screenshot") }}

### Pause Menu

{{ image(src="pause-menu.png" alt="Pause menu screenshot") }}

### Controls Menu

{{ image(src="control-menu.png" alt="Control menu screenshot") }}
